"""
Utilities for downloading and unpacking the CIFAR-100 dataset, originally published
...
def maybe_download_and_extract(data_dir, url='https://www.cs.toronto.edu/~kriz/cifar-100-python.tar.gz'):
...
def unpickle(file):
    ...
    return {
        ...
        'y': np.array(dict[b'fine_labels']).astype(np.uint8)
        }
